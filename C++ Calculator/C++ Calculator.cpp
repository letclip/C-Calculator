...
constexpr double add(const double x, const double y) {     // const because i don't expect anything in this code to be modified by the program in any way, it simply does the calculation and returns the answer.
    return x + y;
}
